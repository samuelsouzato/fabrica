        ...
        <section class="container">
            ...
            @if ($errors->any())
                <div class="alert alert-danger" role="alert">
                    Não há mais vagas para o horário selecionado.
                </div>
            @endif
                    ...
                    <form action="/agendamento/fabrica/create" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="custom-select" name="naturalidade" placeholder="Naturalidade"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <select class="form-control" name="deficiente" id="deficiente" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" onclick="addDep()" class="btn btn-success"
                        ...
                        <div class="row" id="dependente01" style="display: none">
                            <div class="col-md-3">
                                <label>Nome</label>
                                <input type="text" name="dependente_nome" class="form-control"
                                    placeholder="Nome completo">
                            </div>
                            <div class="col-md-3">
                                <label>CPF</label>
                                <input type="text" name="dependente_cpf" id="dependente_cpf" class="form-control"
                                    placeholder="CPF">
                            </div>
                            <div class="col-md-3">
                                <label>Data Nascimento</label>
                                <input type="date" name="dependente_data_nascimento" class="form-control"
            ...
            <div class="row mt-4 d-print-none">
                ...
                <div class="col-md-6 d-print-none">
                    ...
                    <div class="row d-print-none" id="01" style="display: flex">
                        <div class="col-md-12">
                            <select class="form-control" name="horario_visitacao_id" id="horario_visitacao_id" required>
